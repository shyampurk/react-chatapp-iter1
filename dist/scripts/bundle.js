...
var ChatHead = React.createClass({displayName: "ChatHead",
	render:function(){
		return (
...
var ErrorDisplay = React.createClass({displayName: "ErrorDisplay",
	render:function(){
...
var ChatBody = React.createClass({displayName: "ChatBody",
	render:function(){
		
			var messageList = this.props.data.map(function(message,index){
				return(

				     React.createElement("li", {className: "collection-item avatar", key: index}, 
				       React.createElement("img", {src: message.avatar_url, className: "circle"}), 
				       React.createElement("span", {className: "title"}, "Anonymous robot #", message.uid), 
				       React.createElement("p", null, React.createElement("i", {className: "prefix mdi-action-alarm"}), 
				       React.createElement("span", {className: "message-date"}, message.createdTime), React.createElement("br", null), message.message
				       )
				     )		     
    );
			});
...
var ChatForm = React.createClass({displayName: "ChatForm",
	...
	render:function(){
			...
			var avatar_url = "http://robohash.org/" + this.props.user + "?set=set2&bgset=bg2&size=70x70";
		return (
				React.createElement("footer", {className: "teal"}, 
					React.createElement("form", {className: "container", onSubmit: this.handleSubmit}, 
			       React.createElement("div", {className: "row"}, 
			         React.createElement("div", {className: "input-field col s10"}, 
			           React.createElement("i", {className: "prefix mdi-communication-chat"}), 
			           React.createElement("input", {type: "text", placeholder: "Type your message", ref: "Message"
			           }), 
			           React.createElement("span", {className: "chip left"}, 
			             React.createElement("img", {src: avatar_url}), 
			            "Anonymous robot #", UUID
			           )
			         ), 
			         React.createElement("div", {className: "input-field col s2"}, 
			           React.createElement("button", {id: "btn", type: "submit", className: "waves-effect waves-light btn-floating btn-large"}, 
...
func:function(){
 ...
 render:function(){
		return (
				...
				React.createElement(ChatBody, {data: this.state.data}), 
				React.createElement(ChatForm, {onMessageSubmit: this.handleMessageSubmit, user: this.state.user})
				)
			);
	}
});
...
},{"./chatPage":160,"jquery":28,"react":159,"react-dom":30}]},{},[161]);
